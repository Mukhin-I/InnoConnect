...
func (x *DeleteRequestRequest) GetId() int64 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *DeleteRequestRequest) GetCreatorId() int64 {
	if x != nil {
		return x.CreatorId
	}
	return 0
...
const file_request_proto_rawDesc = "" +
	"\n" +
	"\rrequest.proto\x12\arequest\x1a\x1bgoogle/protobuf/empty.proto\"l\n" +
	...
	"\x02id\x18\x01 \x01(\x03R\x02id\x12\x1d\n" +
	"\n" +
	"creator_id\x18\x02 \x01(\x03R\tcreatorId2\xd9\x03\n" +
	...
	"\n" +
	"GetRequest\x12\x1a.request.GetRequestRequest\x1a\x14.request.RequestFull\x12F\n" +
	"\rDeleteRequest\x12\x1d.request.DeleteRequestRequest\x1a\x16.google.protobuf.Empty\x12Q\n" +
...
var file_request_proto_goTypes = []any{
	...
	(*DeleteRequestRequest)(nil),            // 11: request.DeleteRequestRequest
...
var file_request_proto_depIdxs = []int32{
	...
	11, // 6: request.RequestService.DeleteRequest:input_type -> request.DeleteRequestRequest
	0,  // 7: request.RequestService.ApplyToRequest:input_type -> request.ApplyToRequestRequest
	1,  // 8: request.RequestService.CancelRequestApplication:input_type -> request.CancelRequestApplicationRequest
	6,  // 9: request.RequestService.CreateRequest:output_type -> request.RequestFull
	9,  // 10: request.RequestService.GetRequests:output_type -> request.GetRequestsResponse
	6,  // 11: request.RequestService.GetRequest:output_type -> request.RequestFull
	12, // 12: request.RequestService.DeleteRequest:output_type -> google.protobuf.Empty
	2,  // 13: request.RequestService.ApplyToRequest:output_type -> request.ApplyToRequestResponse
	12, // 14: request.RequestService.CancelRequestApplication:output_type -> google.protobuf.Empty
