...
* run ```docker compose --env-file .env -f backend/deployment/docker/docker-compose.yml up -d --build``` or dev build: ```docker compose --env-file .env -f backend/deployment/docker/docker-compose-dev.yml up -d --build```
* And it starts!!!
